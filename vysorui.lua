...
function Library:Window()
    ...
    function Window:LoadPage(index)
        ...
        for i, v in next, TabHolder:GetChildren() do
            if i == index + 1 then
                task.spawn(function()
                    Tween(v, 0.2, {BackgroundColor3 = Color3.fromRGB(39, 127, 168)})
                end)
            end
        end
    end
    ...
    function Window:Tab(pagename)
        ...
        TabName.Parent = Tab
        TabName.BackgroundColor3 = Color3.fromRGB(39, 127, 168)
        ...
        TabTrigger.MouseButton1Click:Connect(function()
            ...
            task.spawn(function()
                Tween(Tab, 0.2, {BackgroundColor3 = Color3.fromRGB(14, 166, 237)})
            end)
            Page.Visible = true
        end)
        ...
        function OuterContainer:Section(secname)
            ...
            function Container:Slider(sldname, min, max, start, callback)
                ...
                SliderOut.BackgroundColor3 = Color3.fromRGB(39, 127, 168)
                ...
                SliderIn.BackgroundColor3 = Color3.fromRGB(14, 166, 237)
                ...
                SliderTrigger.BackgroundColor3 = Color3.fromRGB(39, 127, 168)
            ...
            function Container:Textbox(texname, placeholder, callback)
                ...
                TextboxTyper.PlaceholderColor3 = Color3.fromRGB(39, 127, 168)
